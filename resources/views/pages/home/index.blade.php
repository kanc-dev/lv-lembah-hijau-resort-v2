                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="border-0 card-header align-items-center d-flex">
                                <h4 class="mb-0 card-title flex-grow-1">Kamar Terisi</h4>
                                <div>
                            ...
                            <div class="p-0 border-0 card-header bg-soft-light">
                                <div class="flex-wrap text-center d-flex justify-content-center w-100">
                                                ...
                                                <div class="p-3 border border-dashed border-start-0">
                                                    <h5 class="mb-1">
                                                        <span class="counter-value"
                                                            data-target="{{ $branch->occupancy['occupied'] }}">
                                                        </span>
                                                        / {{ $branch->occupancy['total'] }}
                                                    </h5>
                                                    <p class="mb-0 text-muted">{{ $branch->name }}</p>
                                                    {{-- <p class="mb-0">Kamar Terisi: {{ $branch->occupancy['occupied'] }} /
                                                        {{ $branch->occupancy['total'] }}</p> --}}
                                                </div>
                                            </div>
                                        @endforeach
                                    @endif
