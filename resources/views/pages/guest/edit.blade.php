            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 card-title">Edit Tamu</h5>
                    ...
                    <div class="card-body">
                        <form action="{{ route('guest.update', $data['guest']->id) }}" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                            id="nama" name="nama" value="{{ old('nama', $data['guest']->nama) }}"
                                            required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('jenis_kelamin') is-invalid @enderror"
                                            ...
                                            <option value="L"
                                                {{ old('jenis_kelamin', $data['guest']->jenis_kelamin) == 'L' ? 'selected' : '' }}>
                                                Laki-laki</option>
                                            <option value="P"
                                                {{ old('jenis_kelamin', $data['guest']->jenis_kelamin) == 'P' ? 'selected' : '' }}>
                                                Perempuan</option>
                                        </select>
                                        <div class="invalid-feedback">
                                            @error('jenis_kelamin')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('no_hp') is-invalid @enderror"
                                            id="no_hp" name="no_hp" value="{{ old('no_hp', $data['guest']->no_hp) }}"
                                            required>
                                        <div class="invalid-feedback">
                                            @error('no_hp')
                                                {{ $message }}
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                                            id="email" name="email" value="{{ old('email', $data['guest']->email) }}"
                                            required>
                                        <div class="invalid-feedback">
                                            @error('email')
                                                {{ $message }}
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('kendaraan') is-invalid @enderror"
                                            ...
                                            value="{{ old('kendaraan', $data['guest']->kendaraan) }}" required>
                                        <div class="invalid-feedback">
                                            @error('kendaraan')
                                                {{ $message }}
                                            @else
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('no_polisi') is-invalid @enderror"
                                            ...
                                            value="{{ old('no_polisi', $data['guest']->no_polisi) }}" required>
                                        <div class="invalid-feedback">
                                            @error('no_polisi')
                                                {{ $message }}
                                            @else
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('batch') is-invalid @enderror"
                                            id="batch" name="batch"
                                            value="{{ old('batch', $data['guest']->batch) }}">
                                        <div class="invalid-feedback">
                                            @error('batch')
                                                {{ $message }}
                                            @else
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('tanggal_rencana_checkin', $data['guest']->tanggal_rencana_checkin) }}"
                                            required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('tanggal_rencana_checkout', $data['guest']->tanggal_rencana_checkout) }}"
                                            required>
                                        <div class="invalid-feedback">
                                        ...
                                        <select class="form-select @error('room_id') is-invalid @enderror" id="room_id"
                                            ...
                                            @foreach ($data['rooms'] as $room)
                                                <option value="{{ $room->id }}"
                                                    {{ old('room_id', $data['guest']->room_id) == $room->id ? 'selected' : '' }}>
