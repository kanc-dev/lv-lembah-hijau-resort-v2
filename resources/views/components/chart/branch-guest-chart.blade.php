...
<script>
    ...
    fetch('http://lv-lembah-hijau-resort-hotel.test:8088/branch-room-occupancy') // Gantilah URL API sesuai kebutuhan
        ...
        .then(data => {
            ...
            var chart = new ApexCharts(document.querySelector("#branch-occupancy-chart"), options);
            chart.render();
        })
